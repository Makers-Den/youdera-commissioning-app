...
const Dot = () => <span className="text-brand-two-400 text-2xl">.</span>;
...
const IpPartInput = React.forwardRef<HTMLInputElement, InputProps>(
  (props: InputProps, ref) => (
    <Input maxLength={3} placeholder="0" ref={ref} {...props} />
  ),
);
