    ...
    const customErrorMap: z.ZodErrorMap = (issue, ctx) => {
      ...
      switch (issue.code) {
        ...
        case z.ZodIssueCode.invalid_literal:
          message = intl.formatMessage(
            { defaultMessage: `Invalid literal value, expected {values}` },
            { values: JSON.stringify(issue.expected) },
          );
          break;
        ...
        case z.ZodIssueCode.invalid_union_discriminator:
          message = intl.formatMessage(
            {
              defaultMessage: `Invalid discriminator value. Expected {values}`,
            },
            { values: issue.options.join(', ') },
          );
          break;
        case z.ZodIssueCode.invalid_enum_value:
          message = intl.formatMessage(
            {
              defaultMessage: `Invalid enum value. Expected {values}, received '{received}'`,
            },
            { values: issue.options.join(', '), received: issue.received },
          );
          break;
        ...
        case z.ZodIssueCode.too_small:
          if (issue.type === 'array')
            message = intl.formatMessage(
              {
                defaultMessage: `Array must contain at least {minimum} element(s)`,
              },
            ...
            message = intl.formatMessage(
              {
                defaultMessage: `String must contain at least {minimum} character(s)`,
              },
              { minimum: Number(issue.minimum) },
            );
            ...
            message = intl.formatMessage(
              {
                defaultMessage: `Number must be greater than or equal to {minimum}`,
              },
              { minimum: Number(issue.minimum) },
            );
        ...
        case z.ZodIssueCode.too_big:
          if (issue.type === 'array')
            message = intl.formatMessage(
              {
                defaultMessage: `Array must contain at most {maximum} element(s)`,
              },
            ...
            message = intl.formatMessage(
              {
                defaultMessage: `String must contain at most {maximum} characters`,
              },
              { maximum: Number(issue.maximum) },
            );
          else if (issue.type === 'number')
            message = intl.formatMessage(
              {
                defaultMessage: `Number must be less than or equal to {maximum}`,
              },
              { maximum: Number(issue.maximum) },
            );
          else if (issue.type === 'date')
